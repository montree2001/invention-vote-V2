    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">ตารางรายงานผลการลงคะแนน รวมแต่ละจุด <?php if($row_type['announce']==1) echo "<span class='badge bg-primary rounded-3 fw-semibold'> <i class='ti ti-circle-check'></i> รับรองผลแล้ว</span>"; ?></h3>
                                            ...
                                            while ($row_points_type = $stmt_points_type->fetch(PDO::FETCH_ASSOC)) { ?>
                                                ...
                                                ?>
                                                    <?php if (isset($row_invention_score['points_score'])) { ?>
                                                        ...
                                                        $count_committee++; ?>
                                                    <?php } else { ?>
                                                        <td class='no-vote-container'><div class='no-vote-circle'><i class='ti ti-xbox-x no-vote-icon'></i></div></td>
                                                    <?php } ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="table_report_commitee.php?committee_id=<?php echo $row_committee['committee_id']; ?>&type_id=<?php echo $_GET['type_id']; ?>">  <span class='badge bg-success rounded-3 fw-semibold'><i class='fas fa-info'></i>รายละเอียด</span></a></td>
                                                    </tr>
                                                <?php $count_committee++;
                                                } ?>
                                            </tbody>
