    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title" style="text-align: center;font-size: 30px;">สรุปเหรียญ <?php if($row_type['announce']==1) echo "<span class='badge bg-primary rounded-3 fw-semibold'> <i class='ti ti-circle-check'></i> รับรองผลแล้ว</span>"; ?></h1>
                            ...
                            <table id="table_report" class="table table-striped table-bordered no-wrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">ระดับเหรียญ</th>
                                        <th style="text-align: center;">รางวัล</th> <!-- เพิ่มตรงนี้ -->
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="width: 100px;text-align: center;">
                                                <?php
                                                if ($row_invention['avg_points_score'] >= 80 && $row_invention['avg_points_score'] <= 100) {
                                                    echo "เหรียญทอง";
            ...
            <script>
                $('#table_report').DataTable({
                    ...
                    buttons: [{
                            ...
                            title: 'ตารางสรุปเหรียญ-<?php echo $row_type['type_Name']; ?>',
                            exportOptions: {
