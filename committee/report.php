                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">สถานศึกษา: <?php echo $row['invention_educational']; ?>
                                        <br>จังหวัด: <?php echo $row['invention_province']; ?>
                                    </p>
                                    <!-- Progress Bar -->
                                    <?php
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $percentage ?>%;" aria-valuenow="<?php echo $percentage ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $currentVotes . " คะแนน"; ?> </div>
                                    </div>
